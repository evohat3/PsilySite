...
export default function Contact() {
  ...
  return (
    <div class={`max-w-6xl mx-auto my-6 font-[sans-serif] ${isDarkMode ? 'bg-black text-white' : 'bg-slate-300 text-[#011c2b]'}`}>
            <div class="text-center px-6">
                <h2 class="text-3xl font-extrabold">Contact Us</h2>
                <p class={`text-sm mt-3 ${isDarkMode ? 'text-white' : 'text-[#011c2b]'}`}>Have some big idea or brand to develop and need help?</p>
            </div>
            <div class="grid lg:grid-cols-3 items-center gap-4 p-2  rounded-lg mt-8">
