...
export default function Contact() {
  ...
  const handleSubmit = async () => {
    try {
      const response = await fetch('https://precisionhomenetworks.com/send', {
        method: 'POST',
        headers: {
   ...
   function formatPhoneNumber(phoneNumberString) {
    ...
    if (match) {
        ...
        if (match) {
            ...
            match = cleaned.match(/^(\d{1,3})(\d{1,3})?$/);
            if (match) {
  ...
  return (
    <div className={`max-w-6xl mx-auto my-6 font-[sans-serif] ${isDarkMode ? 'bg-black text-white' : 'bg-slate-300 text-[#011c2b]'}`}>
            <div className="text-center px-6">
                ...
                <p className={`text-sm mt-3 ${isDarkMode ? 'text-white' : 'text-[#011c2b]'}`}>Have some big idea or brand to develop and need help?</p>
            </div>
            <div className="grid lg:grid-cols-3 items-center gap-4 p-2  rounded-lg mt-8">
                    ...
                    <ul className="mt-16 space-y-10">
                        <li className="flex items-center max-lg:justify-center">
                            ...
                            <a href="/" className="text-white text-sm ml-3">
                                <strong>info@precisionhomenetworks.com</strong>
                            </a>
                        </li>
                        ...
                        <li className="flex items-center max-lg:justify-center">
                            ...
                            <a href="j/" className="text-white text-sm ml-3">
                ...
                <div className="p-6 rounded-xl lg:col-span-2">
                    <form>
                        <div className="grid sm:grid-cols-2 gap-8">
                            ...
                            <div className="relative flex items-center">
                                <input type="tel" value={phoneNo} onChange={handlePhoneInput} onKeyDown={handleKeyDown} placeholder="Phone No."
                                    className="px-2 py-3 bg-white text-black w-full text-sm border-b-2 focus:border-[#011c2b] outline-none" />
                            ...
                            <div className="col-span-full">
                                ...
                                <div className="flex max-lg:flex-col lg:space-x-6 max-lg:space-y-6">
                                    <div className="flex items-center mt-3">
                                        <input id="radio1" type="radio" name="value1" className="hidden peer" checked={subject === 'General Inquiry'} onChange={() => setSubject('General Inquiry')} />
                                    ...
                                    <div className="flex items-center mt-3">
                                        <input id="radio2" type="radio" name="value1" className="hidden peer" checked={subject === 'Technical Support'} onChange={() => setSubject('Technical Support')}/>
                                    ...
                                    <div className="flex items-center mt-3">
                                        <input id="radio3" type="radio" name="value1" className="hidden peer" checked={subject === 'Website Feedback'} onChange={() => setSubject('Website Feedback')}/>
